  ...
  return (
    <section className={styles.sectionContainer}>
      <div className={styles.mediaContainer}>
        <a href="https://www.instagram.com/helsinkithings" target="_blank" rel="noopener noreferrer">
      ...
      <div className={styles.mediaContainer}>
        <a href="https://www.tiktok.com/@helsinkithings" target="_blank" rel="noopener noreferrer">
      ...
      <div className={styles.mediaContainer}>
        <a href="https://payhip.com/helsinkithings" target="_blank" rel="noopener noreferrer">
