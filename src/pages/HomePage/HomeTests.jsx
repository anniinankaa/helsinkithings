...
function HomeTests () {
    return (
    <div>
        <HomeTest color='#A7D1F4' header='Pick your vibe' 
        ...
        <HomeTest color='#9EB786' header='Which do you prefer?'
        ...
        <HomeTest color='#FBB8AF' header='Alone or together?'
        ...
        <HomeTest color='#E8D87A' header='Are you a/na'
        ...
        <HomeTest color='#52709F' header='What are you most into?'
